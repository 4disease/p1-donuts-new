...
public class PellStream extends com.example.sping_portfolio.algorithm.pellModel._Pell {
    public PellStream() {
        super();
    }
    public PellStream(int nth) {
        super(nth);
    }
    ...
    */
    ...
    protected void init() {
        ...
        Stream.iterate(new long[]{0, 1}, f -> new long[]{f[1], 2 * f[1] + f[0]})
                .limit(super.size)
    ...
    public static void main(String[] args) {
        com.example.sping_portfolio.algorithm.pellModel._Pell pell = new PellStream();
        pell.print();
    }
}
