...
public class ASCIIArtKira {
    ...
    public byte[]  Grayscale(){
        try {
            BufferedImage img = ImageIO.read(new URL("https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwebstockreview.net%2Fimages%2Fdonuts-clipart-comic-7.png&f=1&nofb=1"));
