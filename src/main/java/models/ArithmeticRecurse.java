...
public class ArithmeticRecurse extends _Arithmetic {
    ...
    */
    ...
    private void initRecurse(long limit, long[] f) {
        ...
        initRecurse(--limit, new long[]{f[1], f[0] + 2});
    }
    ...
    public static void main(String[] args) {
        _Arithmetic arithmetic = new ArithmeticRecurse();  // "FibRecurse" is used as initializer for the "_Fibonacci fibonacci"  object
        arithmetic.print();
    }
}
